...
| :--- | :--- | :--- |
| [**zotero-cli**](https://github.com/fchicout/zotero-cli) | 📚 CLI for importing papers from arXiv/BibTeX directly into Zotero collections with bulk support. | `TeX`, `Shell` |
| [**scholar-doi-scraper**](https://github.com/fchicout/scholar-doi-scraper) | 🔍 Extracts DOIs from Google Scholar results for systematic reviews. | `JavaScript` |
| [**cartolaNext**](https://github.com/fchicout/cartolaNext) | ⚽ Statistical analysis to predict the best team for the next round of CartolaFC. | `Node.js`, `Stats` |
| [**RC_Joypad**](https://github.com/fchicout/RC_Joypad) | 🎮 Code for a custom RC Joypad for Arduino projects. | `C++`, `Arduino` |
...
<div align="left">
  ...
  <a href="https://www.linkedin.com/in/fabiocesar/" target="_blank">
